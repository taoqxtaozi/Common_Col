...
usage() {
    cat <<'EOF'
Usage:
  bash RunNotFromProgressiveCactusPipelineUseThis.sh --input /path/to/aln1.maf /path/to/aln2.maf ... --reference REF --output consensus.maf --threads 60 --common_workers 15 [options]
...
############################
# 13. Delete intermediate directories and intermediate MAF files,
