...
1. reads a partially resolved Newick tree,
...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    ap.add_argument("--tree", required=True, help="Input Newick tree string")
...
def main() -> None:
    ...
    root = reroot_at_reference(raw_root, args.reference)
