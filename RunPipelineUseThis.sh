...
usage() {
    cat <<'EOF'
Usage:
  bash RunPipelineUseThis.sh --input /path/to/aln1.maf /path/to/aln2.maf ... --reference REF --pre output_prefix --threads 60 --common_workers 15 [options]
...
############################
# 14. Delete intermediate directories, keeping only the input MAF files
