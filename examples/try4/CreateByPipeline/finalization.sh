...
RUN_PATH=/picb/phylcomb/taoqixin/cactus-bin-v2.9.2/evolverSimControl_100000long_43taxa_processLostChrom_usetaxadirectly/0530reroot/try4
...
"$patched_halAppendSubtree" ${RUN_PATH}/Root/FinalResultAlignment.hal ${RUN_PATH}/Root/Anc_in2/Anc_in2_aln1.hal Anc_in2 Anc_in2 --merge
...
taxa_args=(GALGA CATAU CHLUN COLLI CUCCA MESUN PTEGU TAUER)
